...
public class DetailActivity extends AppCompatActivity {
    ...
    private TextView descriptionTextView, originTextView, alsoKnownTextView, ingredientsTextView;
    ...
    private void populateUI(Sandwich sandwich) {
        ...
        alsoKnownTextView.setText(alsoKnownAsString.equals("") ? "-" : alsoKnownAsString);
        ingredientsTextView.setText(ingredientsString.equals("") ? "-" : ingredientsString);
    }
}
